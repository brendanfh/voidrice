...
-- theme.font          = "sans 8"
theme.font          = "SourceCodePro-Medium 12"
...
theme.notification_font = "SourceCodePro-Medium 14"
theme.notification_border_color = theme.bg_normal
theme.notification_opacity = .9
theme.notification_margin = 8
theme.notification_shape = helpers.rounded_rect(8)

theme.border_width = 1
theme.border_normal = theme.bg_normal
theme.font = "SourceCodePro-Medium 14"
